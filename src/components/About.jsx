      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 items-center">
        <div className="md:col-span-2 w-full @container">
          <div className="w-full gap-1 overflow-hidden bg-background-dark @[480px]:gap-2 aspect-square rounded-xl flex">
            <div
              className="w-full saturate-120 drop-shadow-2xl drop-shadow-black/50 bg-cover scale-100 bg-no-repeat aspect-auto rounded-xl flex-1 mask-b-from-70% mask-r-from-90% mask-l-from-90% mask-b-to-100% bg-[url('./assets/images/profile-img4.png')] "
        ...
        <div className="md:col-span-3 flex flex-col justify-center items-center w-full h-full">
          <p className="text-white/80 text-base font-barlow text-justify leading-relaxed">
            ...
            with a passion for building beautiful and functional{" "}
            <span className="font-bold text-emerald-500">web applications</span>
            . With a background in computer science and a keen eye for design, I
            specialize in bringing ideas to life from concept to deployment. I
          ...
          <p className="text-white/80 text-base font-barlow text-justify leading-relaxed mt-4">
            ...
            <span className="font-bold text-sky-500">React</span> or building
            robust backend <span className="font-bold text-rose-500">APIs</span>{" "}
            with <span className="font-bold text-yellow-500">Node.js</span>, my
            goal is to create software that is not only efficient and scalable
            but also a delight to use.
          </p>

          <a href={resume} download target="_blank" rel="noopener noreferrer">
            <DrawOutlineButton>
              Download Resume <GrDocumentUser />
            </DrawOutlineButton>
          </a>
        </div>
      </div>
